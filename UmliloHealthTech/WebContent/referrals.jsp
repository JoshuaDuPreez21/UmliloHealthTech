...
<title>Umlilo HealthTech | Referrals</title>
...
<body>
	<aside class="sidebar" aria-label="Nurse workspace menu">
		...
		<nav class="nav-menu">
			...
			<a href="vitals-overview" class="nav-item-link"><i class="bi bi-heart-pulse"></i><span>Vitals Overview</span></a>
			<a href="referrals" class="nav-item-link active"><i class="bi bi-arrow-left-right"></i><span>Referrals</span></a>
